...
describe("Circuit Tests", function () {
    ...
    it("Should generate an invalid proof for ouragan Circuit if we modify the poseidon nonce", async () => {
        ...
        // let witness = await ouraganCircuit.calculateWitness(invalidInput);
    ...
    it("Should generate an invalid proof for ouragan Circuit if we modify the encryption key", async () => {
